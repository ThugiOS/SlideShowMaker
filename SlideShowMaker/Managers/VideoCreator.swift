...
class VideoCreator {
    ...
    func createVideo(videoInfo: VideoInfo, completion: @escaping (URL?) -> Void) {
        ...
        let totalFrames = Int(videoInfo.duration * Double(videoInfo.frameRate))
        ...
        videoWriterInput.requestMediaDataWhenReady(on: queue) {
            ...
            while videoWriterInput.isReadyForMoreMediaData, frameCount < totalFrames {
                ...
                let presentationTime = CMTimeMake(value: Int64(frameCount), timescale: Int32(videoInfo.frameRate))
